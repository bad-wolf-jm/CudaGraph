...
namespace LTSE::SensorModel
{
    ...
    {
        auto lLaserAngleCount       = aWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( 1 );
        ...
        auto lFrameNumber              = MultiTensorValue( aScope, lFrameNumberInitializer, lLaserAngles.Get<sMultiTensorComponent>().Shape() );
    ...
    {
        auto lTraceLengths = aWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( -1 );
        ...
        auto lTilingRepetitions = VectorValue( aScope, aWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( 0 ) );
    ...
    void sBlinderOperationController::Run()
    {
        ...
        MemoryBuffer &lBlockSizes   = lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue;
        MemoryBuffer &lElementCount = lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue;
    ...
    {
        sTensorShape lWaveformTensorShape( aWaveforms.Get<sMultiTensorComponent>().Shape().mShape, sizeof( float ) );
        ...
        sTensorShape lBlockShape = aWaveforms.Get<sMultiTensorComponent>().Shape();
    ...
    OpNode Cfar( Scope &aScope, sFPGAConfiguration const &aConfiguration, sTileConfiguration const &aTileConfiguration, OpNode const &aFilteredWaveforms )
    {
        ...
        sTensorShape lBlockShape = aFilteredWaveforms.Get<sMultiTensorComponent>().Shape();
        lBlockShape.Flatten( -1 );
        lOperandData.mMaxBlockSize      = lBlockShape.mMaxDimensions[0];
        ...
        lNewEntity.Add<sMultiTensorComponent>( aScope.mPool, aFilteredWaveforms.Get<sMultiTensorComponent>().Shape() );
    ...
    OpNode DetectPeaks( Scope &aScope, sFPGAConfiguration const &aConfiguration, sTileConfiguration const &aTileConfiguration, OpNode const &aWaveforms, OpNode const &aThresholds )
    {
        ...
        lNewEntity.Add<sMultiTensorComponent>( aScope.mPool, sTensorShape( aWaveforms.Get<sMultiTensorComponent>().Shape().mShape, sizeof( uint8_t ) ) );
                                                       ...
                                                       OpNode const &aWaveforms )
    {
        ...
        sTensorShape lWaveformTensorShape = aWaveforms.Get<sMultiTensorComponent>().Shape();
    ...
    void sPacketHeaderOperationController::Run()
    {
        ...
        GeneratePacketHeaderOp( lValue, lRands.mVersion.Get<sVectorBufferComponent>().mValue, lRands.mID.Get<sVectorBufferComponent>().mValue,
                                lRands.mSampleCount.Get<sVectorBufferComponent>().mValue, lRands.mMaxDetectionCount.Get<sVectorBufferComponent>().mValue,
                                ...
                                lRands.mWaveformBaseline.Get<sMultiTensorComponent>().mValue, lRands.mBlockSizes.Get<sVectorBufferComponent>().mValue, lRands.mMaxBlockSize,
                                lRands.mHeaderSizes.Get<sVectorBufferComponent>().mValue );
    }
                                  ...
                                  OpNode const &aWaveforms )
    {
        ...
        sTensorShape lOutputShape = aPDNumber.Get<sMultiTensorComponent>().Shape();
        ...
        case sTileConfiguration::PeakDetectorMode::SURFACE_CLOUD:
            ...
            lSampleCountNode = VectorValue( aScope, aWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( -1 ) );
            break;
        default:
            lIDNode          = VectorValue( aScope, std::vector<uint32_t>( lOutputShape.CountLayers(), ID_CLOUD ) );
        ...
        auto lKernelShape = aPDNumber.Get<sMultiTensorComponent>().Shape();
    ...
    {
        std::vector<uint32_t> lScanCount    = aWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( 0 );
        std::vector<uint32_t> lSegmentCount = aWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( 1 );
        ...
        sTensorShape lFilterKernelShape = aWaveforms.Get<sMultiTensorComponent>().Shape();
        ...
        auto lPrechargeShape  = aWaveforms.Get<sMultiTensorComponent>().Shape();
        ...
        auto lSample0Shape = lSample0.Get<sMultiTensorComponent>().Shape();
        ...
        auto lLastIndex = lFilteredWaveforms.Get<sMultiTensorComponent>().Shape().GetDimension( -1 );
        ...
        auto x = lFilteredWaveforms.Get<sMultiTensorComponent>().Shape();
    ...
    {
        sTensorShape lWaveformTensorShape( aDetections.Get<sMultiTensorComponent>().Shape().mShape, sizeof( float ) );
        ...
        sTensorShape lBlockShape = aDetections.Get<sMultiTensorComponent>().Shape();
        lBlockShape.Flatten( -1 );
        lOperandData.mBlockSizes   = VectorValue( aScope, lBlockShape.GetDimension( 0 ) );
        lOperandData.mElementCount = VectorValue( aScope, lBlockShape.GetDimension( -1 ) );
    ...
    void sStructureDetectionsOperationController::Run()
    {
        ...
        MemoryBuffer &lBlockSizes   = lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue;
        MemoryBuffer &lElementCount = lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue;
        MemoryBuffer &lPacketSizes  = lOperandData.mPacketSizes.Get<sVectorBufferComponent>().mValue;
                                   ...
                                   OpNode const &aValidDetections, OpNode const &aValidDetectionCount )
    {
        ...
        sTensorShape lWaveformPacketShape = aWaveforms.Get<sMultiTensorComponent>().Shape();
