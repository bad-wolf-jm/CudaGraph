...
namespace LTSE::SensorModel
{
    ...
    class EnvironmentSampler
    {
      public:
        ...
        /// @brief Retrive the Indices of individual flashes
        OpNode &GetFlashID() { return mFlashIdLUT; }

        /// @brief Retrive the sampled azimuth values
        OpNode &GetAzimuths() { return mSampledAzimuths; }

        /// @brief Retrive the sampled elevation values
        OpNode &GetElevations() { return mSampledElevations; }

        /// @brief Retrive the sampled intensity values
        OpNode &GetIntensities() { return mSampleRayIntensities; }

        /// @brief Retrive the sampled timestamps
        OpNode &GetTimestamps() { return mTimestamps; }
