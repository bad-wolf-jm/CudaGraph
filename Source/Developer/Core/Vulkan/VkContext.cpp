...
namespace LTSE::Graphics::Internal
{
    ...
    VkContext::VkContext( Ref<Core::ViewportClient> aWindow, bool aEnableValidation )
        : mWindow{ aWindow }
    {
    ...
    void VkContext::FreeMemory( VkDeviceMemory aMemory )
    {
    ...
    void VkContext::DestroyCommandBuffer( VkCommandBuffer aBuffer )
    {
    ...
    VkBuffer VkContext::CreateBuffer( VkBufferUsageFlags aBufferFlags, size_t aSize, bool aIsHostVisible, bool aIsCudaShareable )
    {
    ...
    void VkContext::DestroyBuffer( VkBuffer aBuffer )
    {
    ...
    void VkContext::DestroyImage( VkImage aImage )
    {
    ...
    void VkContext::DestroySampler( VkSampler aSampler )
    {
    ...
    void VkContext::DestroyImageView( VkImageView aImageView )
    {
    ...
    void VkContext::DestroyFramebuffer( VkFramebuffer aFramebuffer )
    {
    ...
    void VkContext::DestroyRenderPass( VkRenderPass aRenderPass )
    {
    ...
    VkPipeline VkContext::CreatePipeline( VkGraphicsPipelineCreateInfo aCreateInfo )
    {
    ...
    void VkContext::DestroyPipeline( VkPipeline aFramebuffer )
    {
    ...
    void VkContext::DestroyFence( VkFence aFence )
    {
    ...
    VkSemaphore VkContext::CreateVkSemaphore()
    {
    ...
    void VkContext::DestroySemaphore( VkSemaphore aFence )
    {
    ...
    void VkContext::ResetFences( std::vector<VkFence> aFences )
    {
    ...
    void VkContext::WaitForFences( std::vector<VkFence> aFences, uint64_t aTimeout )
    {
        std::vector<VkFence> aNonNullFences;
        for( auto &lFence : aFences )
        {
    ...
    void VkContext::WaitForFences( std::vector<VkFence> aFences ) { WaitForFences( aFences, std::numeric_limits<uint64_t>::max() ); }
    void VkContext::WaitForFence( VkFence aFence, uint64_t aTimeout ) { WaitForFences( { aFence }, aTimeout ); }
    void VkContext::WaitForFence( VkFence aFence ) { WaitForFences( { aFence } ); }

    std::tuple<VkFormat, uint32_t, VkExtent2D, VkSwapchainKHR> VkContext::CreateSwapChain()
    {
    ...
    void VkContext::DestroySwapChain( VkSwapchainKHR aSwapchain )
    {
        WaitIdle();
    ...
    std::vector<VkImage> VkContext::GetSwapChainImages( VkSwapchainKHR aSwapChain )
    {
    ...
    VkShaderModule VkContext::CreateShaderModule( std::vector<uint32_t> aByteCode )
    {
    ...
    void VkContext::DestroyShaderModule( VkShaderModule aShaderModule )
    {
    ...
    VkDescriptorSetLayout VkContext::CreateDescriptorSetLayout( std::vector<VkDescriptorSetLayoutBinding> aBindings, bool aUnbounded )
    {
    ...
    void VkContext::DestroyDescriptorSetLayout( VkDescriptorSetLayout aDescriptorSetLayout )
    {
    ...
    VkDescriptorPool VkContext::CreateDescriptorPool( uint32_t aDescriptorSetCount, std::vector<VkDescriptorPoolSize> aPoolSizes )
    {
        ...
        lDescriptorPoolCreateInfo.flags         = 0;
    ...
    void VkContext::DestroyDescriptorPool( VkDescriptorPool aDescriptorPool )
    {
    ...
    void VkContext::DestroyPipelineLayout( VkPipelineLayout aPipelineLayout )
    {
    ...
    VkResult VkContext::Present( VkSwapchainKHR aSwapChain, uint32_t aImageIndex, VkSemaphore aWaitSemaphore )
    {
