...
namespace LTSE::Core
{
    ...
    Ref<Texture2D> GenerateBRDFLUT( GraphicContext &a_GraphicContext, int32_t dim )
    {
        ...
        m_BRDFRenderingPipelineCI.ShaderStages                    = { { l_VertexShaderModule, "main" }, { l_FragmentShaderModule, "main" } };
...
#define M_PI 3.14159265359
    ...
    Ref<TextureCubeMap> GenerateIBLCubemap( GraphicContext &a_GraphicContext, Ref<TextureCubeMap> a_Skybox, IBLCubemapType a_Type, int32_t dim )
    {
        ...
        m_CubemapProcessorRenderingPipelineCI.ShaderStages               = { { l_SkyboxVertexShaderModule, "main" }, { l_SkyboxFragmentShaderModule, "main" } };
