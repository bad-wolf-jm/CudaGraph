...
namespace LTSE::TensorOps
{
    ...
    void sBinaryOperationController::Run()
    {
        ...
        else if( lOperandData.mLeftOperand.Has<sMultiTensorComponent>() && lOperandData.mRightOperand.Has<sScalarValueVectorComponent>() )
        {
            auto &lLeftOperandData    = lOperandData.mLeftOperand.Get<sMultiTensorComponent>();
        ...
        else if( lOperandData.mLeftOperand.Has<sScalarValueVectorComponent>() && lOperandData.mRightOperand.Has<sMultiTensorComponent>() )
        {
    ...
    {
        AddOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
    ...
    {
        MultiplyOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                    aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        SubtractOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                    aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        DivideOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                  aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        AndOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
               aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        OrOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
              aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        BitwiseAndOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                      aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        BitwiseOrOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                     aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        EqualOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                 aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        LessThanOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                    aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    {
        LessThanOrEqualOp( aTensorElementType, aOut, aLeft, aRight, aBroadcast.mBroadcastHint, aBroadcast.mBlockSizes.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBlockSize,
                           aBroadcast.mBroadcastDimension.Get<sVectorBufferComponent>().mValue, aBroadcast.mMaxBroadcastDimension );
    }
    ...
    void sWhereOperationController::Run()
    {
        ...
        else if( lOperandData.mValueIfTrue.Has<sMultiTensorComponent>() && lOperandData.mValueIfFalse.Has<sScalarValueVectorComponent>() )
        {
            auto &lValueIfTrue  = lOperandData.mValueIfTrue.Get<sMultiTensorComponent>();
        ...
        else if( lOperandData.mValueIfTrue.Has<sScalarValueVectorComponent>() && lOperandData.mValueIfFalse.Has<sMultiTensorComponent>() )
        {
        ...
        else if( lOperandData.mValueIfTrue.Has<sScalarValueVectorComponent>() && lOperandData.mValueIfFalse.Has<sScalarValueVectorComponent>() )
        {
            auto &lValueIfTrue  = lOperandData.mValueIfTrue.Get<sVectorBufferComponent>();
            auto &lValueIfFalse = lOperandData.mValueIfFalse.Get<sVectorBufferComponent>();
        ...
        else if( lOperandData.mValueIfTrue.Has<sScalarValueVectorComponent>() && lOperandData.mValueIfFalse.Has<sScalarNodeComponent>() )
        {
            auto &lValueIfTrue  = lOperandData.mValueIfTrue.Get<sVectorBufferComponent>();
            auto &lValueIfFalse = lOperandData.mValueIfFalse.Get<sScalarNodeComponent>();
        ...
        else if( lOperandData.mValueIfTrue.Has<sScalarNodeComponent>() && lOperandData.mValueIfFalse.Has<sScalarValueVectorComponent>() )
        {
            auto &lValueIfTrue  = lOperandData.mValueIfTrue.Get<sScalarNodeComponent>();
            auto &lValueIfFalse = lOperandData.mValueIfFalse.Get<sVectorBufferComponent>();
    ...
    void sLinearSpaceOperationController::Run()
    {
        ...
        LinearSpaceOp( lElementType, lValue, lLeft, lRight, lOperandData.mSubdivisions.Get<sVectorBufferComponent>().mValue, lMaxSubdivisions );
    }
    ...
    void sCountTrueOperationController::Run()
    {
        ...
        CountTrueOp( lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue,
    ...
    void sCountNonZeroOperationController::Run()
    {
        ...
        CountNonZeroOp( lElementType, lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue,
                        lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxBlockSize );
    }
    ...
    void sCountZeroOperationController::Run()
    {
        ...
        CountZeroOp( lElementType, lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue,
                     lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxBlockSize );
    }
    ...
    void sArraySummationOperationController::Run()
    {
        ...
        ArraySummationOp( lElementType, lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mBegin.Get<sVectorBufferComponent>().mValue,
                          lOperandData.mEnd.Get<sVectorBufferComponent>().mValue, lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue,
    ...
    void sArraySliceOperationController::Run()
    {
        ...
        ArraySliceOp( lElementType, lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mBegin.Get<sVectorBufferComponent>().mValue,
                      lOperandData.mEnd.Get<sVectorBufferComponent>().mValue, lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue,
                      lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxBlockSize );
    }
    ...
    void sDiffOperationController::Run()
    {
        ...
        DiffOp( lElementType, lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mCount, lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue,
                lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxBlockSize );
    }
    ...
    void sShiftOperationController::Run()
    {
        ...
        ShiftOp( lElementType, lValue, lOperandData.mArray.Get<sMultiTensorComponent>().mValue, lOperandData.mCount, lOperandData.mFillValue.Get<sScalarNodeComponent>().mValue,
                 lOperandData.mElementCount.Get<sVectorBufferComponent>().mValue, lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxBlockSize );
    }
    ...
    void sConv1DOperationController::Run()
    {
        ...
        Conv1DOp( lElementType, lValue, lOperandData.mArray0.Get<sMultiTensorComponent>().mValue, lOperandData.mElementCount0.Get<sVectorBufferComponent>().mValue,
                  lOperandData.mBlockSizes0.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxElementCount0, lOperandData.mMaxBlockSize0,
                  lOperandData.mArray1.Get<sMultiTensorComponent>().mValue, lOperandData.mElementCount1.Get<sVectorBufferComponent>().mValue,
    ...
    void sHCatOperationController::Run()
    {
        ...
        HCatOp( lElementType, lValue, lOperandData.mArray0.Get<sMultiTensorComponent>().mValue, lOperandData.mElementCount0.Get<sVectorBufferComponent>().mValue,
                lOperandData.mArray1.Get<sMultiTensorComponent>().mValue, lOperandData.mElementCount1.Get<sVectorBufferComponent>().mValue,
                lOperandData.mBlockSizes.Get<sVectorBufferComponent>().mValue, lOperandData.mMaxBlockSize );
    }
} // namespace LTSE::TensorOps
